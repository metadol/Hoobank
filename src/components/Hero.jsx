...
const Hero = () => (
  <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    <div className={`flex-col flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
    ...
    <div className={`flex-1 flex ${styles.flexCenter} msd:mr-0 mr-10 relative`}>
      <img src={robot} alt='billing' className='w-[100%] h-[100%] relative z-[5]'/>
      <div className='absolute z-[0] w-[40%] h-[35%] top-0 pink__gradient'/>
      <div className='absolute z-[1] w-[40%] h-[80%] bottom-40 pink__gradient rounded-full'/>
