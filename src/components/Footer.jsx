    ...
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
      <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full `}>
        <div className='flex flex-col justify-start flex-1 mr-10 '>
          <img src={logo} alt='hoobank' className='w-[250px] h-[62px] object-contain'/>
      ...
      <div className='w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45]'>
        <p className={`${styles.paragraph} font-poppins font-normal text-center text-[18px] leading-[27px] text-white text-opacity-60`}>
